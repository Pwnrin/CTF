...
libc 2.27，堆空间开始时固定：0x21000大小，每次设置一个字符到0x20FFF处，而后调用strncmp(flag_addr[index],heap_

base+0x20FFF,2),当此位flag正确，则会比较第二位造成crash，在strncmp返回位置设置为read，即可通过阻塞和EOF来爆破flag
